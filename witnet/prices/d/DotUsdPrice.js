...
// Retrieve DOT/USD-6 price from Coinbase
...
// Retrieve DOT/USD-6 price from Kraken
const kraken = new Witnet.Source("https://api.kraken.com/0/public/Ticker?pair=DOTUSD")
  .parseJSONMap()
  .getMap("result")
  .getMap("DOTUSD")
  .getArray("a")
...
// Retrieve DOT/USD-6 price from Bittrex
const bittrex = new Witnet.Source("https://api.bittrex.com/v3/markets/DOT-USD/ticker")
  .parseJSONMap()
