...
// Retrieve ATOM/USD-6 price from Coinbase
...
// Retrieve ATOM/USD-6 price from Kraken
const kraken = new Witnet.Source("https://api.kraken.com/0/public/Ticker?pair=ATOMUSD")
  .parseJSONMap()
  .getMap("result")
  .getMap("ATOMUSD")
  .getArray("a")
...
// Retrieve ATOM/USD-6 price from Bittrex
const bittrex = new Witnet.Source("https://api.bittrex.com/v3/markets/ATOM-USD/ticker")
  .parseJSONMap()
