...
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=USDTUSD")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()
...
const bitstamp = new Witnet.Source("https://www.bitstamp.net/api/v2/ticker/usdtusd")
  .parseJSONMap()
  .getFloat("last")
  .multiply(10 ** 6)
  .round()
...
const bittrex = new Witnet.Source("https://api.bittrex.com/v3/markets/USDT-USD/ticker")
  .parseJSONMap()
...
const kraken = new Witnet.Source("https://api.kraken.com/0/public/Ticker?pair=USDTUSD")
  .parseJSONMap()
  .getMap("result")
  .getMap("USDTZUSD")
  .getArray("a")
