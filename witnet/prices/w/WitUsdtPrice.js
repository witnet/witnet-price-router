...
// Retrieves WIT/USDT-6 from the BitMart API:
const bitmart = new Witnet.Source("https://api-cloud.bitmart.com/spot/v1/ticker?symbol=WIT_USDT")
  .parseJSONMap()
  .getMap("data")
  .getArray("tickers")
  .getMap(0)
...
// Retrieves WIT/USDT-6 price from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/wit_usdt")
...
const mexc = new Witnet.Source("https://www.mexc.com/open/api/v2/market/ticker?symbol=WIT_USDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
